...
const TOKENS = {
  ...
  USDC: { address: '0xceA9300f2b948710d2653dD7B07f33A8B32118C', decimals: 6 },
...
const ABI = [
  {"name":"allowance","type":"function","stateMutability":"view","inputs":[{"name":"owner","type":"address"},{"name":"spender","tye":"adress"}],"outputs":[{"name":"","type":"uint256"}]},
  {"name":"approve","typ"function","stateMutability":"nonpayable","inputs":[{"name":"spender","type":"address"},{"name":"amount","type":"uint256"}]},
  {
    "name": "requestService",
    "type": "function",
