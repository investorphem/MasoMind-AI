...
const ABI = [
 ...
 {"name":"executeService","type":"function","stateMtability":"nonpayable","inputs":[{"name":"token","type":"address"},{"name":"amount","type":"uint256"},{"name":"prompt","type":"string"},{"name":"serviceType","type":"string"}]}
];
...
export class MasoMind {
  constructor(provider) {
    ...
    this.publicClient = createPublicClient({ chain: celo, tansport: custom(provider) })
